...
`http://localhost:3000/editor`에서 1080 × 1350(4:5) 한 장 표지를 브라우저에서 편집합니다. 사진은 로컬에서만 처리되며, 제목·부제·출처의 글꼴/색상/위치·이미지 위치·그라데이션을 조절하고 PNG로 저장할 수 있습니다. Topic Radar 카드의 **이 주제로 카드 만들기**로 제목과 출처를 전달할 수 있습니다.
